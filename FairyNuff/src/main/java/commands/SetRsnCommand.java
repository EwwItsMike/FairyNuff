...
public class SetRsnCommand extends Command {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        try {
            ...
            event.reply("This RSN is already registered! If this is incorrect, please reach out via a ticket in https://discord.com/channels/332595657363685377/1283170720599248938").queue();
        }
    }
}
