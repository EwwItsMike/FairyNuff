...
public class LumberEmbedCommand extends EmbedCommandTemplate {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        addField("__Elite Steps__ <:Elite:633732493228638209>", "Lumberyard compass steps got moved to [these](https://media.discordapp.net/attachments/894988133794451456/1075410402634104952/elite_spots.jpg?width=683&height=683)");
