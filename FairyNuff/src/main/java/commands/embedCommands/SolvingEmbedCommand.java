...
public class SolvingEmbedCommand extends EmbedCommandTemplate {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        addField("__Solving Preset Maker__ (Courtesy of <@145884917627224065>, <@300296497277173761>", "The [Preset Maker](https://discord.com/channels/332595657363685377/1084955288437784666) will make you optimal presets based on what you have\n*Note:it is still in beta and the creators are asking for suggestions and feedback.*");
